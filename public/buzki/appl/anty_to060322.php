...
function checkForm () {
  ...
  else if ( document.form2.cust_id.value == '')
  {
    ...
    spr=0;
  ...
  else if ((document.form2.czas_umowy[1].checked && document.form2.wybor1[0].checked) || document.form2.wybor1[3].checked){
	  ...
	  else if (( document.form2.signdate.value == '')  && document.form2.wybor1[0].checked)
	  {
	 ...
	 else if ((!data_p.test(document.form2.signdate.value)) && document.form2.wybor1[0].checked) {
...
{
if (((document.form2.czas_umowy[1].checked) && (document.form2.wybor1[0].checked)) || (document.form2.wybor1[3].checked))
{
...
?>
	...
	<INPUT TYPE="radio" NAME="czas_umowy" VALUE="do10brak" onClick="Show_Stuff(display2)">Umowa podpisana do 10 dni (brak danych klienta w systemie - podaj nr telefonu poprzedzony T np. t223456789).<BR>
	</td></tr>
<?php
echo "
