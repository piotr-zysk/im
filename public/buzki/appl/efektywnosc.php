...
echo "
<TABLE class='body_table'>
<TR><TD colspan='7' class='table_log'><B>RAPORT</B></TD></TR>
<TR>
<TD class='table_log'>Login</TD>
...
<TD class='table_log'>Operacja</TD>
<TD class='table_log'>Ilosc</TD>
<TD class='table_log'>Czas</TD>
<TD class='table_log'>Efektywnosc</TD>
</TR>
";
...
$sql="SELECT SUM(log.Ilosc) AS ile ";
$sql.="FROM FROM EfektywnoscOperacje oper, EfektywnoscLog log ";
$sql.="WHERE log.Id_operacji=oper.Id_operacji ";
...
/*	$id_log = $member['Id'];
	$login_log = $member['login'];
	$dataOd = $member['DataGodzOd'];
	$dataDo = $member['DataGodzDo'];
	$ilosc_log = $member['ile'];
	$operacja_oper = $member['Operacja'];
	$imie = $member['f_name'];
