...
<select name="report_task"<?php echo ($report_type != '2') ? ' disabled="disabled"' : '';?>>
	...
	<?php
		$taski = $db->select("select Id_operacji, Operacja from Efektywnosc21Operacje where Efektywnosc21Operacje.finansowy = 'P4'");
...
<select name="report_agent"<?php echo ($report_type != '3') ? ' disabled="disabled"' : '';?>>
	...
	<?php	
		$agenci = $db->select("
			...
			WHERE Efektywnosc21Operacje.finansowy = 'P4'
...
<?php
	...
	FROM Efektywnosc21Log 
		INNER JOIN Efektywnosc21Operacje ON Efektywnosc21Log.czynnosc = Efektywnosc21Operacje.Id_operacji
	WHERE Efektywnosc21Log.start_czas >= $start_date And Efektywnosc21Log.start_czas < $end_date AND Efektywnosc21Operacje.finansowy = 'P4'
...
FROM Efektywnosc21Log
	INNER JOIN tab_users_all ON Efektywnosc21Log.agent = tab_users_all.id
	INNER JOIN Efektywnosc21Operacje ON Efektywnosc21Log.czynnosc = Efektywnosc21Operacje.Id_operacji
WHERE tab_users_all.id = $report_agent And Efektywnosc21Log.start_czas >= $start_date And Efektywnosc21Log.start_czas < $end_date AND Efektywnosc21Operacje.finansowy = 'P4'
GROUP BY Efektywnosc21Operacje.Operacja;";
