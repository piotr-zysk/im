...
if (($wybor1=='zrezygnowal') and ($czas_umowy=='do10jest'))
	{
		...
		$query1 = $db->query("INSERT INTO callregistry_anty_10 (oper_id, data, czas, cust_id, name, street, zip, city, tel, signdate, pan) VALUES ('$xmbid','$data','$czas', '$cust_id', '$name', '$street', '$zip', '$city', '$tel', '$signdate', '$pan')");
	}
