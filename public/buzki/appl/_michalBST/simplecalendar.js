	...
	*/
	...
	function Calendar(){
	  ...
	  if (browser.ns4 && browser.platform=='Win32') {
	    this.containerLayer.clip.height=100;
	    this.containerLayer.clip.width=100;
	  }
	...
	Calendar.prototype.buildString = function(){
	  ...
	  if (this.hasDropDown) {
	    ...
	    tmpStr += '<table border="0" cellspacing="0" cellpadding="0"><tr><td class="cal"><a href="javascript: g_Calendar.changeMonth(-1);"><img name="calendar" src="gfx/down.gif" border="0" alt=""></a></td><td class="cal" width="100%" align="center">' + this.months[this.month] + '</td><td class="cal"><a href="javascript: g_Calendar.changeMonth(+1);"><img name="calendar" src="gfx/up.gif" width="8" height="12" border="0" alt=""></a></td></tr></table>';
	  }
	  tmpStr += '</td>';
