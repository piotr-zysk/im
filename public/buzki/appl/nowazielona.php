...
if (((document.form2.czas_umowy[1].checked) && (document.form2.wybor1[0].checked)) || ((document.form2.czas_umowy[2].checked) && (document.form2.wybor1[0].checked)) || (document.form2.wybor1[3].checked) || document.form2.czas_umowy[3].checked)
{
...
if (@$level==1)
	...
	<B>
	<INPUT TYPE="radio" NAME="wybor1" VALUE="zrezygnowal" onClick="Show_Stuff(display2)">Klient zrezygnowal CPS<BR>
	<INPUT TYPE="radio" NAME="wybor1" VALUE="zrezygnowal" onClick="Show_Stuff(display2)">Klient zrezygnowal - pelna rezygnacja (klienci na WLR pending)<BR>
	<INPUT TYPE="radio" NAME="wybor1" VALUE="zrezygnowal" onClick="Show_Stuff(display2)">Klient zrezygnowal - miesieczna rezygnacja (klienci Active WLR oraz Active CPS)<BR>
	...
	<INPUT TYPE="radio" NAME="wybor1" VALUE="nie_zrezygnowal" onClick="Show_Stuff(display2)">Klient nie zrezygnowal<BR>
		<INPUT TYPE="radio" NAME="wybor1" VALUE="nie_zrezygnowal" onClick="Show_Stuff(display2)">Klient nie zrezygnowal - czesciowa rezygnacja (rezygnacja z WLR)<BR>
